...
function CoupleInfo({ data }: CoupleInfoProps) {
  return (
          ...
          <div className="group relative bg-gradient-to-br from-white via-white/95 to-gray-50/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 border border-black/10 hover:border-black/30 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.15)] hover:-translate-y-2">
            ...
            <div className="relative text-center space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-light text-black mb-4">{data.groomName}</h3>
              </div>
                ...
                <div className="space-y-2 text-xs sm:text-sm text-gray-700">
                  {data.groomFatherName && (
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span>{data.groomFatherName}</span>
                    </div>
                  )}
                  {data.groomMotherName && (
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-black">어머니</span>
                      <span>{data.groomMotherName}</span>
                    </div>
                  )}
                </div>
              )}
          ...
          <div className="group relative bg-gradient-to-br from-white via-white/95 to-gray-50/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 border border-black/10 hover:border-black/30 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.15)] hover:-translate-y-2">
            ...
            <div className="relative text-center space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-light text-black mb-4">{data.brideName}</h3>
              </div>
              {(data.brideFatherName || data.brideMotherName) && (
                <div className="space-y-2 text-xs sm:text-sm text-gray-700">
                  {data.brideFatherName && (
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-black">아버지</span>
                      <span>{data.brideFatherName}</span>
                    </div>
                  )}
                  {data.brideMotherName && (
                    <div className="flex items-center justify-center gap-2">
                      <span className="text-black">어머니</span>
                      <span>{data.brideMotherName}</span>
                    </div>
                  )}
                </div>
              )}
